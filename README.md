...
UPDATE 5/3/2022: First comprehensive range tests done (line of sight, antennas parallel), and there is a clear winner! Choose the initialization option below for range up to 33 m: The other options lead to 5-10 m at best. This option has been the default for some time.  Use the new "high power" library for > 50 m range under ideal conditions. Battery life will be shortened!
```
//tag:
