...
The plot below is from a run in which 1000 random positions were generated within the box defined by the anchors, noisy anchor distances were calculated, and were used to make 1000 position estimates, each an average of 10 independent position calculations from 10 sets of noisy distance data. Noise from the radio estimates was simulated by adding +/- 10 cm to the calculated distances.  
