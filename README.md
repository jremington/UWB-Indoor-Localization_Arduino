...
minor changes required to eliminate compilation errors using the ESP32_Arduino IDE. I've added some required for the tag autocalibrate procedure, so please use the library version in this repository.
